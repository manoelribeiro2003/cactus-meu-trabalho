...
class ProjetosController extends AppController
{
    ...
    public function add()
    {
        ...
        $situations = $this->Projetos->Situations->find('list', ['limit' => 200]);
        $startups = $this->Projetos->Startups->find('list', ['limit' => 200]);
        $this->set(compact('projeto', 'situations', 'startups'));
    }
