    ...
    <div class="mr-auto p-2">
        ...
        <div class="p-2">
            <span class="d-none d-md-block">
                ...
                <?= $this->Form->postLink(__('Apagar'), ['controller' => 'Carousels', 'action' => 'delete', $carousel->id], ['class' => 'btn btn-outline-danger btn-sm', 'confirm' => __('Relamente deseja apagar o slide do carousel # {0}?', $carousel->id)]) ?>
            </span>
            <div class="dropdown d-block d-md-none">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                    ...
                    <?= $this->Form->postLink(__('Apagar'), ['controller' => 'Carousels', 'action' => 'delete', $carousel->id], ['class' => 'dropdown-item', 'confirm' => __('Relamente deseja apagar o slide do carousel # {0}?', $carousel->id)]) ?>                                    
                </div>
            </div>
        </div>
</div><hr>
